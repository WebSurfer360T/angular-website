  ...
  createDb() {
    ...
    const pages = [
      ...
      {id: 'footer',
        ...
        developer: 'Telma Tavares',
        developerlink: 'https://github.com/WebSurfer360T',
      },
      {id: 'blog',
        tagline: 'My thoughts',
...
const websites = [
  {id: 1, link: 'https://facebook.com/', title: 'Facebook', target: '_blank', username: '', icon: 'facebook'},
  {id: 2, link: 'https://googleplus.com/', title: 'Google+', target: '_blank', username: '+', icon: 'google-plus'},
  {id: 3, link: 'https://twitter.com/', title: 'Twitter', target: '_blank', username: '', icon: 'twitter'},
  {id: 4, link: 'https://instagram.com/', title: 'Instagram', target: '_blank', username: '', icon: 'instagram'},
  {id: 5, link: 'https://behance.com/', title: 'Behance', target: '_blank', username: '', icon: 'behance'},
];
